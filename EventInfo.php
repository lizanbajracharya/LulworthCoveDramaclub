...
<div>
<a class="btn btn-rounded btn-success" href="AddEvent.php">Add New Event</a>
</div>
...
<table class="mt-3 table--UI" border="dark">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><a class="btn btn-rounded btn-success" href="EditEvent.php?id=<?php echo $row['Event_Id']?>">Edit</a> <a class="btn btn-rounded btn-success" href="DeleteEvent.php?id=<?php echo $row['Event_Id']?>" onclick="Javascript: return confirm('Are you sure you want to delete?');">Delete</a></td>
    </tr>
        <?php
        $i++;}
        ?>
