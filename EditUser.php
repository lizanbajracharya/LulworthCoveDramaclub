...
<body>
  ...
  <div class="page-wrapper padding-t-a padding-b-a">
      <div class="wrapper wrapper--a">
          <div class="card-4">
              <div class="card-body">
                  <h2 class="title text-center font-weight-bold">Edit User</h2>
                  <form method="post" name="edit" id="edit" action="EditUser_operation.php">
                    <input type="hidden" name="id" value="<?php echo $row['U_id']?>">
                      ...
                      <div class="button--panel-2">
                          <input type="submit" class="button" title="EditUser" name="EditUser" value="Edit User"></input>
                      </div>
                      </div>
                  </form>
              </div>
